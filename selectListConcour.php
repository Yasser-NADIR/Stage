<?php 
    ...
    $req = $pdo->prepare("SELECT * FROM t_candidat WHERE id_candidat in ( SELECT id_condidat FROM t_liste_concour WHERE id_concour=:idConcour) AND id_candidat not in( SELECT id_condidat FROM t_liste_candidat_concour WHERE id_concour=:idConcour) ");
